...
class _DegreeEditor extends React.PureComponent<DegreeEditorProps, DegreeEditorState> {
...
export const DegreeEditor = (_DegreeEditor as any) as React.ComponentType<DegreeEditorProps>;
